            ...
            if (CNPJPrestador == "04.335.535/0002-55")  //Insert BD SuperTerminais Table
            {
                ...
                if (superterminais.BeginAnalysis())
                {
                    ...
                    try
                    {
                        ...
                        query = "insert into Notas (NFe, RPS , DiscriminacaodoServico , ValorLiquido , ValorServico , ISSQNRetino , CODServico , NFeSub , DataHoraEmissao , Competencia , CODVerificacao , CNPJPrestador , CNPJTomador , RazaoSocialNomePrestador , DescontoIncondicionado , DescontoCondicionado , RetencoesFederais , OutrasRetencoes , PIS , COFINS , IR , INSS , CSLL) values ('" + nfe + "','" + rps + "','" + dis + "','" + valorliquido + "','" + valorservico + "','" + ISSQNRetido + "','" + CODServico + "','" + NFeSub + "','" + DataHoraEmissao + "','" + Competencia + "','" + CODVerificacao + "','" + CNPJPrestador + "','" + CNPJTomador + "','" + RazaoSocialNome + "','" + DescontoIncondicionado + "','" + DescontoCondicionado + "','" + RetençõesFederais + "','" + OutrasRetenções + "','" + PIS + "','" + COFINS + "','" + IR + "','" + INSS + "','" + CSLL + "')";
